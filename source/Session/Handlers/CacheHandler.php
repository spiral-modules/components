...
class CacheHandler implements \SessionHandlerInterface
{
    ...
    {
        $this->cacheStore->delete($this->prefix . $session_id);
    }
    ...
    {
        return $this->cacheStore->get($this->prefix . $session_id);
    }
    ...
    {
        return $this->cacheStore->set($this->prefix . $session_id, $session_data, $this->lifetime);
    }
}