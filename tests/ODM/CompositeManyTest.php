...
class CompositeManyTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCompositeOneWithValue()
    {
        ...
        $admin = $odm->instantiate(Admin::class, ['pieces' => [['value' => 'abc']]]);
    ...
    public function testCompositeHasByEntity()
    {
        ...
        $this->assertTrue($admin->pieces->has(
            $odm->instantiate(DataPiece::class, ['value' => 'abc'])
        ));
    }
    ...
    public function testCompositeFindOneByQuery()
    {
        ...
        $this->assertEquals(
            $odm->instantiate(DataPiece::class, ['value' => 'abc'])->packValue(),
    ...
    public function testCompositeFindOneByEntity()
    {
        ...
        $this->assertCount(1, $admin->pieces);
        $entity = $odm->instantiate(DataPiece::class, ['value' => 'abc']);
    ...
    public function testCompositeSetValue()
    {
        ...
        $entity1 = $odm->instantiate(DataPiece::class, ['value' => 'abc1']);
        $entity2 = $odm->instantiate(DataPiece::class, ['value' => 'abc2']);
    ...
    public function testPullOne()
    {
        ...
        $admin->pieces->pull($odm->instantiate(DataPiece::class, ['value' => 888]));
    ...
    public function testPullMultiple()
    {
        ...
        $admin->pieces->pull($odm->instantiate(DataPiece::class, ['value' => 123]));
        $this->assertCount(1, $admin->pieces);
    ...
    public function testPushOne()
    {
        ...
        $admin->pieces->push($odm->instantiate(DataPiece::class, ['value' => 888]));
        $this->assertCount(2, $admin->pieces);
    ...
    public function testPushMultiple()
    {
        ...
        $admin->pieces->push($odm->instantiate(DataPiece::class, ['value' => 888]));
        $admin->pieces->push($odm->instantiate(DataPiece::class, ['value' => 888]));
        $admin->pieces->push($odm->instantiate(DataPiece::class, ['value' => 333]));
    ...
    public function testAddOne()
    {
        ...
        $admin->pieces->add($odm->instantiate(DataPiece::class, ['value' => 888]));
        $this->assertCount(2, $admin->pieces);
    ...
    public function testAddMultiple()
    {
        ...
        $admin->pieces->add($odm->instantiate(DataPiece::class, ['value' => 888]));
        $admin->pieces->add($odm->instantiate(DataPiece::class, ['value' => 888]));
        $admin->pieces->add($odm->instantiate(DataPiece::class, ['value' => 333]));
