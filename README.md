...
* Simple Hybrid ORM (DataMapper + ActiveRecord) with the plans to become a cleaner data mapper (non breaking), includes database scaffolding, relations (+polymorphic for fun), eager loading and easy joins
