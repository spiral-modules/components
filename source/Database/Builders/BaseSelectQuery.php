...
/**
 * BaseSelectQuery provides basic functionality for any select query without query building,
 * unions and ability to specify source tables. This class used as parent for Database\SelectQuery and
 * for ORM\Selector.
 *
    ...
    PaginableInterface
{
     ...
     * aggregation methods().
     *
     * You have to specify cache store if no global container mounted.
     *
